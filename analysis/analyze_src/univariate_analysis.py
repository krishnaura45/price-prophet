...
# Defining Interface for Univariate Analysis strategies
...
# Implementing concrete strategy for analyzing Numerical Features
...
# Implementing concrete strategy for analyzing Categorical Features
...
# Defining Context Class for UnivariateAnalysisStrategy
...
# Implementing strategy using context
